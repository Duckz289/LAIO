    ...
    <div id="top" className="laio-landing min-h-screen overflow-x-hidden bg-[#fffdf7] text-[#173f34]">
      ...
      <main>
        ...
        >
          ...
          <div className="relative mx-auto grid w-full max-w-[1180px] items-center gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:gap-20">
            <div className="relative z-10 max-w-[650px]">
              <p className="hero-copy-one mb-5 inline-flex items-center gap-2.5 rounded-full border border-[#173f3433] bg-[#fff4c566] py-2 pl-2.5 pr-4 text-xs font-black uppercase tracking-[0.14em]">
                <span className="h-2 w-2 rounded-full bg-[#f0513e]" aria-hidden="true" />
                Học từ vựng theo nhịp của bạn
              </p>
              <h1
                id="hero-title"
                className="hero-copy-two landing-display text-[clamp(3.15rem,7vw,6.4rem)] font-black leading-[1.03] tracking-[-0.065em] text-[#173f34]"
              >
                Từ mới vào đầu.
        ...
        <section id="features" aria-labelledby="features-title" className="bg-[#fffdf7] px-5 py-24 sm:px-8 lg:py-32">
          <div className="mx-auto max-w-[1180px]">
            <ScrollReveal className="mx-auto max-w-[780px] text-center">
              ...
              <h2 id="features-title" className="landing-display mt-4 text-4xl font-black leading-[1.08] tracking-[-0.045em] sm:text-5xl lg:text-6xl">
            ...
            <ScrollReveal className="mt-14 grid gap-x-12 sm:grid-cols-2" delay={80}>
              {features.map((feature, index) => {
                const Icon = feature.icon;
                return (
                  <article
                    key={feature.title}
                    className="group flex gap-5 border-t-2 border-[#173f341f] py-8 first:border-t-0 sm:gap-6 sm:py-9 sm:[&:nth-child(2)]:border-t-0"
                  >
                    <div
                      className={`${feature.color} ${feature.accent} feature-character grid h-20 w-20 shrink-0 place-items-center rounded-[26px] shadow-sm transition-transform duration-300 group-hover:-rotate-6 sm:h-24 sm:w-24 sm:rounded-[30px]`}
                    >
                      <Icon className="h-8 w-8 sm:h-9 sm:w-9" strokeWidth={2.4} aria-hidden="true" />
                      <span className="feature-character-eye left-[21px] sm:left-[26px]" aria-hidden="true" />
                      <span className="feature-character-eye right-[21px] sm:right-[26px]" aria-hidden="true" />
                    </div>

                    <div className="min-w-0 pt-1">
                      <div className="flex items-baseline gap-3">
                        <span className="section-kicker">{feature.label}</span>
                        <span className="text-[11px] font-black text-[#173f3459]">0{index + 1}</span>
                      </div>
                      <h3 className="landing-display mt-2 text-2xl font-black leading-[1.15] tracking-[-0.035em] sm:text-[1.7rem]">
                        {feature.title}
                      </h3>
                      <p className="mt-2.5 text-sm font-semibold leading-6 text-[#426157]">{feature.description}</p>
                    </div>
                  </article>
                );
              })}
          ...
          <div className="mx-auto max-w-[1180px]">
            <ScrollReveal className="grid items-end gap-6 lg:grid-cols-[1fr_0.75fr]">
              <div>
                ...
                <h2 id="method-title" className="landing-display mt-4 max-w-[760px] text-4xl font-black leading-[1.08] tracking-[-0.045em] sm:text-5xl lg:text-6xl">
              ...
              {steps.map((step, index) => {
                ...
                return (
                  <ScrollReveal key={step.number} delay={index * 100}>
                    <article className="relative min-h-[350px] overflow-hidden rounded-[30px] bg-[#fffdf7] p-7 shadow-[0_2px_6px_rgba(23,63,52,0.06),0_16px_32px_-12px_rgba(23,63,52,0.14)]">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-black uppercase tracking-[0.18em]">Bước {step.number}</span>
                        <div className={`grid h-14 w-14 place-items-center rounded-2xl shadow-sm ${step.color}`}>
                          <Icon className="h-6 w-6" aria-hidden="true" />
                        </div>
                      </div>
                      <div className="mt-20">
                        <h3 className="landing-display text-3xl font-black leading-[1.15] tracking-[-0.04em]">{step.title}</h3>
        ...
        <section aria-labelledby="visual-title" className="bg-[#28336f] px-5 py-20 text-white sm:px-8 lg:py-28">
          <div className="mx-auto grid max-w-[1180px] items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <ScrollReveal>
              ...
              <h2 id="visual-title" className="landing-display mt-4 text-4xl font-black leading-[1.08] tracking-[-0.045em] sm:text-5xl lg:text-6xl">
        ...
        <section aria-labelledby="facts-title" className="bg-[#fffdf7] px-5 py-24 sm:px-8 lg:py-32">
          <div className="mx-auto max-w-[1180px]">
            <ScrollReveal className="rounded-[36px] bg-[#173f34] p-7 text-white sm:p-10 lg:p-14">
              <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
                <div>
                  <p className="section-kicker !text-[#f8df7d]">Cơ chế đang chạy thật</p>
                  <h2 id="facts-title" className="landing-display mt-4 text-4xl font-black leading-[1.08] tracking-[-0.045em] sm:text-5xl">
              ...
              >
                <motion.article variants={listItem} className="rounded-[26px] bg-[#f8df7d] p-6 text-[#173f34]">
                  <p className="landing-display text-5xl font-black tracking-[-0.06em]">
                    <CountUp value={20} />
                  </p>
                  <p className="mt-3 text-sm font-black">từ tối đa được lập kế hoạch cho một lượt ôn</p>
                </motion.article>
                <motion.article variants={listItem} className="rounded-[26px] bg-[#f3a5c2] p-6 text-[#173f34]">
                ...
                <motion.article variants={listItem} className="rounded-[26px] bg-[#80b7ff] p-6 text-[#173f34]">
        ...
        <section id="reviews" aria-labelledby="reviews-title" className="bg-[#82cfca] px-5 py-24 sm:px-8 lg:py-32">
          <div className="mx-auto max-w-[1180px]">
            <ScrollReveal className="max-w-[780px]">
              <p className="section-kicker">Tự đánh giá sau buổi đầu</p>
              <h2 id="reviews-title" className="landing-display mt-4 text-4xl font-black leading-[1.08] tracking-[-0.045em] sm:text-5xl lg:text-6xl">
                Ba điều bạn phải nhìn thấy, không cần tin lời quảng cáo.
              </h2>
            </ScrollReveal>

            <motion.div
              className="mt-12 grid gap-px overflow-hidden rounded-[30px] bg-[#173f34] shadow-[0_2px_6px_rgba(23,63,52,0.08),0_20px_40px_-16px_rgba(23,63,52,0.2)] lg:grid-cols-3"
              variants={listContainer}
              initial="hidden"
              whileInView="visible"
              ...
              {[
                ...
                return (
                  <motion.article
                    ...
                    className="flex flex-col bg-[#fffdf7] p-6 sm:p-8"
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-black uppercase tracking-[0.16em] text-[#f0513e]">Kiểm tra 0{index + 1}</span>
                      <div className={`${item.color} ${item.accent} grid h-11 w-11 place-items-center rounded-xl border-2 border-current/20`}>
                        <Icon className="h-5 w-5" aria-hidden="true" />
                      </div>
                    </div>
                    <h3 className="landing-display mt-6 text-xl font-black tracking-[-0.03em]">{item.title}</h3>
                    <p className="mt-2.5 text-sm font-semibold leading-6 text-[#426157]">{item.text}</p>
                  </motion.article>
                );
              })}
            </motion.div>
        ...
        <section id="faq" aria-labelledby="faq-title" className="bg-[#fffdf7] px-5 py-24 sm:px-8 lg:py-32">
          <div className="mx-auto grid max-w-[1180px] gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            <ScrollReveal>
              ...
              <h2 id="faq-title" className="landing-display mt-4 text-4xl font-black leading-[1.08] tracking-[-0.045em] sm:text-5xl">
        ...
        <section aria-labelledby="final-cta-title" className="bg-[#f3a5c2] px-5 py-20 sm:px-8 lg:py-28">
          <ScrollReveal className="mx-auto max-w-[980px] text-center">
            <div className="mx-auto mb-7 grid h-20 w-20 place-items-center rounded-[28px] bg-[#fffdf7] shadow-sm">
              <Volume2 className="h-9 w-9" aria-hidden="true" />
            </div>
            <h2 id="final-cta-title" className="landing-display text-4xl font-black leading-[1.05] tracking-[-0.05em] sm:text-6xl lg:text-7xl">
            ...
            <motion.button
              ...
              className="group mt-8 inline-flex min-h-14 items-center justify-center gap-2 rounded-full bg-[#173f34] px-8 text-base font-black text-white hover:bg-[#0f3028]"
            >
              Tạo tài khoản LAIO
              <ArrowRight className="h-5 w-5 transition-transform group-hover:translate-x-1" aria-hidden="true" />
            </motion.button>
